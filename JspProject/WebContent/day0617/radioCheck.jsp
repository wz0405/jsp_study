		...
		<table class="table table-striped" style="width: 50%">
			<tr>
				<td><b>지금계절은?</b> &nbsp; <input type="radio" name="season"
					...
					name="season" value="summer">summer &nbsp; <input
					type="radio" name="season" value="fall">fall &nbsp; <input
					type="radio" name="season" value="winter">winter &nbsp;</td>
			</tr>

			<tr>
				<td><b>좋아하는 야식은?</b> <input type="checkbox" name="yasik"
					value="치맥">치맥 &nbsp; <input type="checkbox" name="yasik"
					value="족발">족발 &nbsp; <input type="checkbox" name="yasik"
					value="피자">피자 &nbsp; <input type="checkbox" name="yasik"
					value="곱창">곱창 &nbsp;</td>
			</tr>
			<tr>
